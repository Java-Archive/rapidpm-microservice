...
public class PropertyServiceRestEndpointTest003 extends BasicRestTest {
  ...
  final String propertyfile = PropertyServiceRestEndpointTest003.class.getResource("test.properties").getPath().substring(1);
  final String clientfile = PropertyServiceRestEndpointTest003.class.getResource("clients.txt").getPath().substring(1);
